    ...
    <div class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <div>
                        @if(strtolower($device->status) === 'connected')
                            <form action="{{ route('admin.wa-device.logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold rounded-lg transition" onclick="return confirm('Yakin ingin log out?')">Logout Device</button>
                            </form>
                        @endif
                    </div>
                </header>
                ...
                <div class="mt-6 text-center border-t pt-6" id="qr-container">
                    <button id="btn-generate-qr" class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-lg transition mb-4">
                        Generate QR Code
                    </button>
                    <!-- Modal Konfirmasi/QR -->
                        ...
                        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                            ...
                            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                ...
                                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    <button type="button" id="btn-close-modal" class="mt-3 w-full inline-flex justify-center rounded-lg border border-gray-300 px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 sm:mt-0 sm:ml-3 sm:w-auto">
                                        Tutup
                                    </button>
                                </div>
                            </div>
